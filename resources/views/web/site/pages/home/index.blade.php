                ...
                <div class="row gap-2">
                    <div class="col-sm order-sm-2">
                        <!-- <img src="assets/images/banner.jpg" class="img-fluid banner-img banner-img" alt="banner-image" -->
                            <!-- height="200"> -->
                        <img src="{{asset("web/images/banner.jpg")}}" class="img-fluid banner-img banner-img" alt="banner-image"  
                             height="200">  
                    </div>
...
<div class="card p-2" style="width: 18rem;">
                    ...
                    <img src="{{\App\Helpers\FileHelper::git_file_url($doc->image)}}" alt="" class="card-img-top rounded-circle card-image-circle"/>
                    <div class="card-body d-flex flex-column gap-1 justify-content-center">
                        <h4 class="card-title fw-bold text-center">{{$doc->name}}</h4>
                        <a href="{{route('reservation.show',  $doc->id  )}}" class="btn btn-outline-primary card-button">Browse Doctors</a>
                    </div>
                </div>
@endforeach
            ...
            <section class="splide home__slider__doctors mb-5">
              ...
              @foreach ($doctors as $doctor )
                     <li class="splide__slide">
                            <div class="card p-2" style="width: 18rem;">
                                <img src="{{\App\Helpers\FileHelper::git_file_url($doctor->image)}}" class="card-img-top rounded-circle card-image-circle"
                                    alt="major">
                                <div class="card-body d-flex flex-column gap-1 justify-content-center">
                                    ...
                                    <a href="{{route('reservation.show',  $doc->id  )}}" class="btn btn-outline-primary card-button">Book an
                                        appointment</a>
                                </div>
                            </div>
                        </li>
        ...
        <div class="banner container d-block d-lg-grid d-md-block d-sm-block">
            ...
            <div class="bottom--right bg-blue text-white">
                <img src="{{asset('web/images/banner.jpg')}}" class="img-fluid banner-img">
            </div>
        </div>
@endsection
...
<script src="{{asset('web/scripts/home.js')}}"></script>
